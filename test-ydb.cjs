...
const d = new Driver({
  connectionString: "grpcs://ydb.serverless.yandexcloud.net:2135/?database=/ru-central1/b1guc5cn5a6d63lgsuiq/etnjqd1tqkrk2upndh4i",
  authService
});

d.ready(5000).then(r => {
  console.log("DB Connection Success:", r);
  process.exit(0);
}).catch(e => {
